...
module.exports = {
    ...
    async execute(message,args){
        ...
        if(!message.member.hasPermission("MANAGE_ROLES")){
            ...
            return message.channel.send("This server doesn't have a mute role, once you mute a member one will be created")
        }
        ...
        if(!muteDoc){
            ...
            return message.channel.send("I can'\t unmute this member because their roles are equal or greater to mine")
        }
        else if(muteRole.position >= message.guild.me.roles.highest.position){
            return message.channel.send("I can'\t unmute members because the muterole is higher than or equal to mine")
        }
